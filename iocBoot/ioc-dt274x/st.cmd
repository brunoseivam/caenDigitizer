...
epicsEnvSet("PREFIX", "MPEX:DIAG:CAEN1")
epicsEnvSet("PORT",   "DIG1")
epicsEnvSet("ADDR",   "dig2://192.168.99.148")

epicsEnvSet("LD_LIBRARY_PATH", "/usr/local/lib")
epicsEnvSet("AS_PATH", "$(TOP)/iocBoot/$(IOC)/autosave")
#--
epicsEnvSet("ENGINEER", "Diego Omitto")
epicsEnvSet("LOCATION", "Srv Room")
epicsEnvSet("WIKI", "")
#--
...
#IOCSTATS db
dbLoadRecords("$(TOP)/db/iocAdminSoft.db", "IOC=$(PREFIX)-STAT")
